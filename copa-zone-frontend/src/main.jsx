...
const DEFAULT_DESCRIPTION =
  'O CopaZone ajuda vocÃª a criar ligas, convidar amigos e acompanhar palpites da Copa do Mundo 2026.';
...
const publicPages = {
  '/como-funciona': {
    ...
    intro:
      'O CopaZone organiza a disputa em um fluxo simples: vocÃª cria ou entra em uma liga, faz seus palpites e acompanha a pontuaÃ§Ã£o com seus amigos.',
    sections: [
      { title: 'Crie sua liga', text: 'Monte uma liga para reunir amigos, famÃ­lia ou colegas em uma disputa simples durante a Copa.' },
      { title: 'Convide participantes', text: 'Compartilhe o acesso da liga com quem vai participar e mantenha todos no mesmo espaÃ§o.' },
      { title: 'Acompanhe a disputa', text: 'Veja palpites, resultados e pontuaÃ§Ã£o em uma experiÃªncia pensada para ser clara do inÃ­cio ao fim.' },
    ],
  },
  '/copa-do-mundo-2026': {
    ...
    sections: [
      { title: 'Jogos da Copa', text: 'Acompanhe os confrontos da competiÃ§Ã£o dentro das ligas em que vocÃª participa.' },
      { title: 'Palpites organizados', text: 'Registre seus palpites em um lugar Ãºnico, sem depender de planilhas ou mensagens espalhadas.' },
      { title: 'Disputa entre amigos', text: 'Acompanhe a pontuaÃ§Ã£o da liga e veja quem estÃ¡ melhor na rodada.' },
    ],
  },
  '/regras': {
    eyebrow: 'Regras',
    title: 'Regras do bolÃ£o da CopaZone',
    description:
      'ConheÃ§a as regras gerais para participar de ligas, enviar palpites e acompanhar a pontuaÃ§Ã£o no CopaZone.',
    intro:
      'As regras ajudam a manter a disputa simples, justa e fÃ¡cil de acompanhar para todos os participantes.',
    sections: [
      { title: 'Palpites antes do jogo', text: 'Envie seus palpites dentro do prazo indicado para que todos participem em igualdade.' },
      { title: 'Ligas com convite', text: 'Cada liga reÃºne seus prÃ³prios participantes, mantendo a disputa no grupo certo.' },
      { title: 'PontuaÃ§Ã£o da liga', text: 'A classificaÃ§Ã£o mostra o desempenho dos participantes conforme os jogos acontecem.' },
    ],
  },
  '/faq': {
    eyebrow: 'FAQ',
    ...
    description:
      'Tire dÃºvidas sobre cadastro, ligas, palpites e funcionamento geral do CopaZone.',
    intro:
      'Reunimos as principais dÃºvidas para ajudar novos participantes a entenderem rapidamente como usar a CopaZone.',
    sections: [
      { title: 'Preciso criar conta?', text: 'Sim. O cadastro permite guardar suas ligas, seus palpites e sua pontuaÃ§Ã£o.' },
      { title: 'Posso convidar amigos?', text: 'Sim. A ideia do CopaZone Ã© reunir pessoas em ligas para acompanhar a Copa juntas.' },
      { title: 'A CopaZone Ã© oficial da FIFA?', text: 'NÃ£o. A CopaZone Ã© um aplicativo recreativo independente para bolÃµes e ligas entre amigos.' },
    ],
  },
};
...
function Seo({ title, description = DEFAULT_DESCRIPTION, path, robots = 'index,follow' }) {
  ...
  useEffect(() => {
    ...
    const fullTitle = title ? `${title} | CopaZone` : 'CopaZone | BolÃ£o da Copa do Mundo 2026';
...
function GuardScreen({ title = 'Validando sessÃ£o' }) {
  return (
    <main className="auth-shell">
      <Seo title="Validando sessÃ£o" robots="noindex,nofollow" />
...
function LandingPage() {
  return (
    <main className="landing-page">
      <Seo
        title="BolÃ£o da Copa do Mundo 2026"
        description="Crie uma liga da Copa do Mundo 2026, convide amigos e acompanhe palpites e pontuaÃ§Ã£o no CopaZone."
        path="/"
      />
      <section className="landing-hero">
        <div>
          <p className="eyebrow">CopaZone</p>
          <h1>BolÃ£o da Copa do Mundo entre amigos</h1>
          <p>
            Crie sua liga, convide participantes e acompanhe palpites e pontuaÃ§Ã£o durante a Copa do Mundo.
          </p>
        ...
        <div className="landing-summary">
          {[
            { icon: ShieldCheck, title: 'Conta protegida', desc: 'Acesse suas ligas e seus palpites com seguranÃ§a.' },
            { icon: Users, title: 'Ligas com amigos', desc: 'ReÃºna seu grupo em uma disputa simples de acompanhar.' },
            { icon: Trophy, title: 'Copa do Mundo', desc: 'Palpites e pontuaÃ§Ã£o focados nos jogos da Copa.' },
          ].map((item) => {
      ...
      <section className="landing-preview-section" aria-labelledby="landing-preview-title">
        <div className="landing-preview-heading">
          ...
          <p>Organize sua liga, acompanhe o chaveamento e compare os palpites da turma em uma experiÃªncia feita para a Copa.</p>
        </div>
        ...
        <div className="landing-preview-grid">
          <article className="landing-preview-card dashboard-shot">
            ...
            <div className="preview-league-row">
              <span>BolÃ£o da Firma</span>
              <strong>Modo Copa</strong>
            </div>
            <div className="preview-league-row">
              <span>FamÃ­lia 2026</span>
          ...
          <article className="landing-preview-card bracket-shot">
            ...
            <div className="preview-prediction">
              ...
              <strong>Brasil 2 x 1 JapÃ£o</strong>
            </div>
          </article>
          ...
          <article className="landing-preview-card ranking-shot">
            ...
            <div className="preview-live-pill">AtualizaÃ§Ã£o ao vivo</div>
          </article>
        </div>
      </section>
    </main>
  ...
  return (
    <main className="landing-page public-info-page">
      ...
      <section className="public-info-shell">
        ...
        <nav className="public-info-nav" aria-label="PÃ¡ginas pÃºblicas da CopaZone">
  ...
  return (
    <main className="not-found-page">
      <Seo
        ...
        description="O endereÃ§o informado nÃ£o existe ou nÃ£o estÃ¡ mais disponÃ­vel no CopaZone."
        robots="noindex,nofollow"
      />
      <section className="not-found-panel">
        <p className="eyebrow">Erro 404</p>
        <h1>PÃ¡gina nÃ£o encontrada</h1>
        <p>O endereÃ§o informado nÃ£o existe ou nÃ£o estÃ¡ mais disponÃ­vel.</p>
...
function AppRoutes() {
  ...
  async function logout() {
    ...
    try {
      ...
      toast.error(error.message || 'NÃ£o foi possÃ­vel sair agora.');
    } finally {
        ...
        <Route
          ...
          element={
            <ProtectedShellRoute
              ...
              isLoggingOut={isLoggingOut}
              title="InÃ­cio"
              subtitle="Acompanhe suas ligas, atividades e ligas pÃºblicas da CopaZone."
            >
              <DashboardPage />
            </ProtectedShellRoute>
          }
        ...
        <Route
          ...
          element={
            <ProtectedShellRoute
              ...
              isLoggingOut={isLoggingOut}
              title="Minhas ligas"
              subtitle="Ligas pÃºblicas e privadas aparecem aqui quando vocÃª participa delas."
            >
              <MyLeaguesPage />
            </ProtectedShellRoute>
          }
        ...
        <Route
          ...
          element={
            <ProtectedShellRoute
              ...
              onLogout={logout}
              isLoggingOut={isLoggingOut}
              title="Ligas pÃºblicas"
              subtitle="Explore ligas abertas. Ligas privadas aparecem para vocÃª depois da inscriÃ§Ã£o."
            >
              <PublicLeaguesPage />
            </ProtectedShellRoute>
          }
        ...
        <Route
          ...
          element={
            <ProtectedShellRoute
              ...
              subtitle="Cole o cÃ³digo de convite para acessar uma liga privada."
            >
              <JoinLeaguePage />
            </ProtectedShellRoute>
          }
        ...
        <Route
          ...
          element={
            <ProtectedShellRoute
              ...
              isLoggingOut={isLoggingOut}
              title="Dados da Copa"
              subtitle="Veja o calendÃ¡rio de jogos, grupos e chaveamento da Copa do Mundo."
            >
              <WorldCupDataPage />
            </ProtectedShellRoute>
          }
        ...
        <Route
          ...
          element={
            <ProtectedShellRoute
              ...
              isLoggingOut={isLoggingOut}
              title="Criar liga"
              subtitle="Configure uma liga pÃºblica ou privada para disputar a Copa com seus amigos."
            >
              <CreateLeaguePage />
            </ProtectedShellRoute>
          }
